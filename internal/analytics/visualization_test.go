...
func TestRenderSparkline(t *testing.T) {
	t.Run("basic sparkline", func(t *testing.T) {
	...
	t.Run("flat values", func(t *testing.T) {
...
func TestRenderBarChart(t *testing.T) {
	t.Run("basic bar chart", func(t *testing.T) {
		labels := []string{"A", "B", "C"}
...
func TestRenderTrendChart(t *testing.T) {
	t.Run("basic trend chart", func(t *testing.T) {
		trends := []TrendData{
	...
	t.Run("flat trends", func(t *testing.T) {
		trends := []TrendData{
